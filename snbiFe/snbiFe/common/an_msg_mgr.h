...
typedef struct an_msg_package_ {
    ...
    an_cert_req_t signed_cert_request;
    an_key_t public_key;
...
boolean an_msg_mgr_outgoing_ipv6_na(an_pak_t *pak, an_if_t ifhndl, 
                        an_ipv6_hdr_t *ipv6_hdr, an_icmp6_hdr_t *icmp6_hdr);
boolean
an_msg_mgr_receive_an_message(uint8_t *msg_block, an_pak_t *pak, 
                              an_if_t ifhndl);
...
boolean an_msg_mgr_verify_anra_signature(an_msg_package *msg_package, 
                                         an_cert_t cert);
...
void
an_cp_msg_block_to_pak (an_pak_t * pak,uint8_t *msg_block,uint8_t *temp_msg_block,uint16_t msg_len);
#endif
