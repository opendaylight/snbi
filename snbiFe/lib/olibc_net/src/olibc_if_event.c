...
olibc_if_event_cbk (olibc_fd_event_hdl fd_event_hdl) 
{
    ...
    retval = olibc_fd_event_get_args(fd_event_hdl,
            (void **) &if_event_listener);
    olibc_if_event_listener_func_t if_event_listener_cbk = 
        if_event_listener->if_event_listener_cbk;
        ...
        *if_event_listener_hdl)
{
    ...
    *if_event_listener_hdl = if_event_listener;
    ...
    cleanup: 
    {
        if(&if_event_listener->if_event_nl_sock_addr) {
            olibc_nl_sock_uninit(&if_event_listener->if_event_nl_sock_addr);
        }
        if(if_event_listener) {
