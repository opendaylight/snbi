                           ...
                           an_pak_t *pak, an_if_t ifhndl)
{
    ...
    case AN_MSG_IDP_INTENT:
#ifndef AN_IDP_PUSH 
        an_idp_incoming_intent_message_v2(msg_package);
#else
     ...
     case AN_MSG_IDP_INTENT_VERSION:
        an_idp_incoming_intent_version_message_v2(msg_package);
        break;
 
     case AN_MSG_IDP_INTENT_REQUEST:
        an_idp_incoming_intent_request_message_v2(msg_package);
        break;
#endif
 
      case AN_MSG_IDP_ACK:
#ifndef AN_IDP_PUSH
        an_idp_incoming_ack_message_v2(msg_package);
#else
    ...
    case AN_MSG_CNP_ACK:
        an_cnp_receive_pak(pak, msg_package); 
        break;
    default:
